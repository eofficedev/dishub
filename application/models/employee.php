...
class Employee extends CI_Model {
    ...
    function get_detail_emp($username) {
        $this->db->select('A.emp_num,A.emp_id as id_emp, A.emp_job, A.email_password,A.email_username,A.emp_firstname,A.emp_lastname,A.job_code,A.org_code,A.org_id,B.emp_role as emp_role,B.emp_username,C.org_id as org_idd');
        $this->db->from('hrms_employees as A');
